...
export class DinamicaService implements OnInit {
    ...
    constructor() {
        this.dinamicas = [
         { id: 1, dinamicaId: 41, fechaInicio: new Date('February 4, 2016 10:13:0'), fechaFinal: new Date('February 7, 2016 10:13:00'),
           lugar: 'Catedral Del Espiritu Santo' },
         { id: 2, dinamicaId: 42, fechaInicio: new Date('May 7, 2016 12:13:00'), fechaFinal: new Date('May 10, 2016 10:13:00'),
           lugar: 'Iglesia Santo Niño' },
         { id: 3, dinamicaId: 43, fechaInicio: new Date('June 12, 2016 04:13:00'), fechaFinal: new Date('June 15, 2016 10:13:00'),
           lugar: 'Iglesia Nuestra Sra del Carmen' },
         { id: 4, dinamicaId: 44, fechaInicio: new Date('July 24, 2016 07:13:00'), fechaFinal: new Date('July 27, 2016 10:13:00'),
        ...
        this.dinamica = {
           id: 1, dinamicaId: 41, fechaInicio: new Date('February 4, 2016 10:13:00'), fechaFinal: new Date('February 7, 2016 10:13:00'),
           lugar: 'Catedral Del Espiritu Santo'};
    }
